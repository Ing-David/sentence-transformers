...
class DocumentTransformer(nn.Sequential):
    """
    ...
    def encode(self, document: str,
        ...
        :param document: the integral text to embed
        :param rnn_model: If true, put the embedding into RNN model with attention mechanism
        ...
        # Convert integral text to list of sentences
